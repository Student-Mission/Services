...
import { MdDashboard, MdOutlineDashboard, MdOutlineSettings, MdSettings, MdHelpOutline, MdHelp} from "react-icons/md";
...
function Sidebar({links={menu: [], account: []}, show, expanded, setExpanded, current}) {
