        ...
        <div className={`pt-[130px]`}>
            ...
            <div className={`mt-14 pb-5 grid grid-cols-12 gap-6`}>
                <div className={`col-span-12 lg:col-span-4`}>
                    <div className={`shadow-2xs bg-white p-3 py-5`}>
                        <div className={`flex items-center justify-center`}>
                            <Avatar alt={data.profile.username} src={data.profile.picture} className={`w-[100px]! h-[100px]! bg-blue-main text-3xl! roboto`} />
                        </div>
                                    ...
                                    data.current_missions.map((mission, index)=>(
                                        <div key={index} className={`h-[55px] px-4 grid grid-cols-12 border-b border-gray-200`}>
                                            ...
                                            <div className={`h-full col-span-2 flex items-center roboto`}>
                                                <Chip className={`roboto-light text-[12px]! ${statusStyles[mission.status].sx}`}>
                                                    {statusStyles[mission.status].text}
                                                </Chip>
                                            </div>
                                        </div>
                                    ))
